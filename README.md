...
| Self-hosted | Your own Bitwarden or Vaultwarden instance |
...
## 🏠 Self-hosted Bitwarden or Vaultwarden
...
### Bitwarden or Vaultwarden on the same network as Nextcloud

If Bitwarden or Vaultwarden uses an internal hostname or IP, Nextcloud must be allowed to connect locally:
